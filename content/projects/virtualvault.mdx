...
repository: satwikbhasin/virtual-vault-portfolio-template
published: true
desktopSupported: true
mobileSupported: true
techStack: [UI/UX, Vercel Deployment, React]
---
...
Source code at [GitHub](https://github.com/satwikbhasin/virtual-vault-portfolio-template)
