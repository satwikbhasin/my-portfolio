---
title: The TODO App
description: This project is a full-stack web app, featuring a React-based frontend and a Django backend, providing a seamless and interactive user experience for managing todos
date: "2024-07-26"
...
**_Note:_** _Currently the deployment is down to avoid AWS charges_

## Overview

The TODO App is a full-stack web application for managing todos, developed with a React frontend and a Django backend. It features user authentication, CRUD operations, light/dark mode, and responsive design. The frontend is a Progressive Web App (PWA) for an app-like experience, while the backend handles authentication, data persistence, and RESTful API endpoints.

The app leverages AWS for deployment, using S3 for hosting the frontend, CloudFront as the CDN, and an EC2 instance for the backend, ensuring fast, reliable, and scalable access.
